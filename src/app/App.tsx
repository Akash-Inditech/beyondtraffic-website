...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-amber-50 to-yellow-50 relative overflow-x-hidden">
      ...
      <section className="relative pt-2 md:pt-4 pb-6 md:pb-10 px-4 sm:px-6 lg:px-8 overflow-hidden bg-white">
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 xl:gap-14 items-start">
            ...
            <div className="lg:col-span-6 xl:col-span-6 text-left">
              ...
              <motion.p
                ...
                className="text-sm md:text-base text-gray-600 max-w-xl mb-4 md:mb-5 leading-relaxed"
              >
              ...
              <motion.div
                ...
                className="mt-3 md:mt-4 flex items-center gap-5 text-[11px] md:text-xs font-bold uppercase tracking-widest text-gray-500"
              >
            ...
            <div className="lg:col-span-6 xl:col-span-6 lg:mt-[2rem] xl:mt-[2.25rem]">
              <HeroTrackingScene />
            </div>
          </div>
        </div>
